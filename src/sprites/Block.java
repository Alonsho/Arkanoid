...
public class Block implements Collidable, Sprite, HitNotifier {
    ...
    private HashMap<Integer, java.awt.Color> hitToColorMap;
     ...
     */
    public Block(Rectangle rec, java.awt.Color color, int counter) {
        this.rec = rec;
        this.color = color;
     ...
     */
    public Block(Rectangle rec, int counter, HashMap<Integer, java.awt.Color> hitToColorMap,
    ...
    /**
     * removeFromGame - remove the block from the gameLevel.
     * <p>
     *
     * <p>
     *
